...
// Sample 10 — the Web half of the Postgres Aspire sample. AppHost.cs provisions "postgres" and
...
// Run standalone with:
//   dotnet run --project samples/10-aspire-postgres-wide/Web -- "<connection-string>"
