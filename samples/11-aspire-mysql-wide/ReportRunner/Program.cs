...
// Sample 11 — the ReportRunner half of the MySQL Aspire sample. Started by AppHost.cs with the
// "widetransactions" connection string injected via WithReference; run standalone with:
//   dotnet run --project samples/11-aspire-mysql-wide/ReportRunner -- "<connection-string>"
//
...
Console.WriteLine("Running wide-transactions report against MySQL...");
