...
public class MySqlKeysetSourceTests : IClassFixture<MySqlServerFixture>
{
    ...
    public MySqlKeysetSourceTests(MySqlServerFixture fixture) => _fixture = fixture;
    ...
    public async Task Materializes_typed_columns()
    {
        ...
        var source = Source.MySql(_fixture.ConnectionString, Sql).Keyset<Sale, long>(v => v.Id, pageSize: 10);
